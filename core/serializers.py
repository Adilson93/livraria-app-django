...
class EditoraNestedSerialazer(ModelSerializer):
    class Meta:
        model = Editora
        fields = ("nome",)
...
class LivroDetailSerializer(ModelSerializer):
    ...
    #editora = EditoraNestedSerialazer()
    ...
    def get_autores(self, instace):
        nomes_autores = []
        autores = instace.autores.get_queryset()
...
class ItemCompraSerializer(ModelSerializer):
    ...
    def get_total(self, instace):
        return instace.quantidade * instace.livro.preco
...
class CriarEditarCompraSerializar(ModelSerializer):
